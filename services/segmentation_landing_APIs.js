...
const getSegmentationLandingRoute=(req,res)=>{
...
const getSegmentationLandingRouteForReactLT=(req,res)=>{
    var audioId = req.query.audio_id;
    var audio_url = "";
...
module.exports={
    getSegmentationLandingRoute,
    getSegmentationLandingRouteForReactLT
}