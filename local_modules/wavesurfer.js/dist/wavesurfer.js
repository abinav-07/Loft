    ...
    return /******/ (function(modules) { // webpackBootstrap
        ...
        ({
                        ...
                        _createClass(MultiCanvas, [{
                            ...
                            value: function updateProgress(position) {
                                ...
                                $("#peaks-container").css({
                                    ...
                                    "-ms-transform": `translateX(0%) rotate(90deg) translateX(${position * (-1) }px)`,
                                    "-o-transform": `translateX(0%) rotate(90deg) translateX(${position * (-1) }px)`,
                                    "-webkit-transform": `translateX(0%) rotate(90deg) translateX(${position * (-1) }px)`,
                                    "transform": `translateX(0%) rotate(90deg) translateX(${position * (-1) }px)`
                                });
                                if (parseInt(position * (-1)) < -200) {
                                    $("#top-div-for-scrolling-enabling").css({ "display": "none" });
                                } else if (parseInt(position * (-1)) > -200) {
            ...
            /***/
                 ...
                 * changed here in progress COlor
                 * @property {string} progressColor='#fff' The fill color of the part of the
                        ...
                        _createClass(WaveSurfer, [{
                            ...
                            value: function createDrawer() {
                                    ...
                                    this.drawer.on('scroll', function(e) {
                                        var progress = spectrum.getCurrentTime() / spectrum.getDuration();
                                        var minPxDelta = 1 / spectrum.params.pixelRatio;
                                        var pos = Math.round((progress) * spectrum.drawer.getWidth()) * minPxDelta;
