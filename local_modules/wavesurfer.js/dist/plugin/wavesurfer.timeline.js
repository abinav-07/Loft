                        ...
                        _createClass(TimelinePlugin, [{
                            ...
                            value: function fillText(text, x, y) {
                                    ...
                                    $(text).css({
                                        ...
                                        "transform": "rotate(10deg)" /* For modern browsers(CSS3)  */
                                    });
                                    ...
                                    this.canvases.forEach(function(canvas) {
                                        ...
                                        if (xOffset + canvasWidth > x) {
                                            ...
                                            context.translate(x - xOffset, y / 2);
                            ...
                            value: function defaultFormatTimeCallback(seconds, pxPerSec) {
                                    ...
                                    var minutes = parseInt(Math.round(seconds) / 60, 10);

                                    seconds = parseInt(Math.round(seconds) % 60, 10); // fill up seconds with zeroes

                                    seconds = seconds < 10 ? '0' + Math.round(seconds) : Math.round(seconds);
                                    return "0".concat(minutes, ":").concat(Math.round(seconds));
                                    //}
                                    return Math.round(Math.round(seconds) * 1000) / 1000;
                                }
                                /**
